...
I'm A simple Zee5 webseries link downloader bot With Permanent Thumbnail Support💯.

Please send me any Zee5 link, I can upload it to telegram as File/Video.

Currently I'm in beta mode 🥺, If found any bugs, report @allbotdeveloper !
...
<b>Creater :</b> @allbotdeveloper

<b>Language :</b> <code>Python3</code>

<b>Library :</b> <a href='https://docs.pyrogram.org/'>Pyrogram 1.0.7</a> 

<b>Source Code :</b> 👉 <a href='https://github.com/chittaranjan2020/zee5-premium-downloader'>Click Here</a>"""
...
<i>NOTE : Taking high resolutions may result in files above 9GB and hence cannot Upload to TG. So better select a medium resolution.</i> 😇
"""    
    
    UPGRADE_TEXT = "PING at @allbotdeveloper"
